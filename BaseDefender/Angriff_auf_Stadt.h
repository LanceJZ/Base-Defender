...
public:
	...
	void Initialize(sf::Texture *texture, sf::Texture *shotTexture, sf::Texture *bombTexture, sf::Texture *bombExplosion, sf::Vector2u windowSize, sf::Vector2f worldSize);
